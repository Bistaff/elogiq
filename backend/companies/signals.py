...
def populate_initial_data(sender, **kwargs):
    ...
    # CHIP INC
    products = [
        {'name': "NanoChip X1", 'description': "High performance nano chip", 'price': 200, 'ordering_cost': 50, 'tiers': [(1, 200), (500, 180), (1000, 160)],
        ...
        {'name': "NanoChip X2", 'description': "Advanced nano chip with AI capabilities", 'price': 250, 'ordering_cost': 60, 'tiers': [(1, 250), (500, 230), (1000, 210)],
        ...
        {'name': "NanoChip X3", 'description': "Ultra-fast nano chip for data centers", "price": 300, 'ordering_cost': 70, 'tiers': [(1, 300), (500, 280), (1000, 260)],
    ...
    # SERVER INC
    products = [
        {'name': "Server Unit 1", 'description': "High performance server unit", 'price': 500, 'ordering_cost': 50, 'tiers': [(1, 500), (10, 450), (50, 400)],
        ...
        {'name': "Server Unit 2", 'description': "Advanced server unit with cloud capabilities", 'price': 600, 'ordering_cost': 60, 'tiers': [(1, 600), (10, 550), (50, 500)],
        ...
        {'name': "Server Unit 3", 'description': "Ultra-fast server unit for data centers", 'price': 700, 'ordering_cost': 70, 'tiers': [(1, 700), (10, 650), (50, 600)],
    ...
    # APPS INC
    products = [
        {'name': "App Suite 1", 'description': "Comprehensive app suite for businesses", 'price': 100, 'ordering_cost': 50, 'tiers': [(1, 100), (10, 90), (50, 80)],
        ...
        {'name': "App Suite 2", 'description': "Advanced app suite with AI capabilities", 'price': 150, 'ordering_cost': 60, 'tiers': [(1, 150), (10, 140), (50, 130)],
        ...
        {'name': "App Suite 3", 'description': "Ultra-fast app suite for data centers", 'price': 200, 'ordering_cost': 70, 'tiers': [(1, 200), (10, 190), (50, 180)],
